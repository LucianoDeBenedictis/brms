...
#> Chain 3:                1.225 seconds (Sampling)
#> Chain 3:                2.611 seconds (Total)
#> Chain 3: 
#> 
...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 5.852 seconds (Warm-up)
#> Chain 1:                4.066 seconds (Sampling)
#> Chain 1:                9.918 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 5.835 seconds (Warm-up)
#> Chain 2:                4.061 seconds (Sampling)
#> Chain 2:                9.896 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 5.823 seconds (Warm-up)
#> Chain 3:                4.083 seconds (Sampling)
#> Chain 3:                9.906 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 6.071 seconds (Warm-up)
#> Chain 4:                4.068 seconds (Sampling)
#> Chain 4:                10.139 seconds (Total)
#> Chain 4: 
summary(fit2)
#>  Family: cumulative 
#>   Links: mu = logit 
