...
Set up an autoregressive (AR) term of order p in brms. The function does
...
#> Chain 4: 
#> Chain 4:  Elapsed Time: 1.004 seconds (Warm-up)
#> Chain 4:                0.227 seconds (Sampling)
#> Chain 4:                1.231 seconds (Total)
#> Chain 4: 
summary(fit)
#>  Family: gaussian 
#>   Links: mu = identity 
