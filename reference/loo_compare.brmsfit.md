...
All `brmsfit` objects should contain precomputed criterion objects. See
...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 1.596 seconds (Warm-up)
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 1.657 seconds (Warm-up)
#> Chain 2:                0.778 seconds (Sampling)
#> Chain 2:                2.435 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 1.631 seconds (Warm-up)
#> Chain 3:                0.777 seconds (Sampling)
#> Chain 3:                2.408 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 1.695 seconds (Warm-up)
#> Chain 4:                0.776 seconds (Sampling)
#> Chain 4:                2.471 seconds (Total)
#> Chain 4: 
