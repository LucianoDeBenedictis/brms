...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 3.01 seconds (Warm-up)
#> Chain 1:                4.456 seconds (Sampling)
#> Chain 1:                7.466 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2:                5.003 seconds (Sampling)
...
#> Chain 3:                3.741 seconds (Sampling)
#> Chain 3:                3.867 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 2.659 seconds (Warm-up)
#> Chain 4:                4.73 seconds (Sampling)
#> Chain 4:                7.389 seconds (Total)
#> Chain 4: 
...
#> Chain 2:                0.558 seconds (Sampling)
#> Chain 2:                2.039 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 1.398 seconds (Warm-up)
#> Chain 3:                0.556 seconds (Sampling)
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 1.59 seconds (Warm-up)
#> Chain 4:                0.554 seconds (Sampling)
#> Chain 4:                2.144 seconds (Total)
#> Chain 4: 
summary(fit4)
#>  Family: weibull 
#>   Links: mu = log 
