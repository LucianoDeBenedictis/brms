...
#> Chain 1:                0.807 seconds (Sampling)
#> Chain 1:                2.496 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 1.639 seconds (Warm-up)
#> Chain 2:                0.779 seconds (Sampling)
#> Chain 2:                2.418 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 1.867 seconds (Warm-up)
#> Chain 3:                1.557 seconds (Sampling)
#> Chain 3:                3.424 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 1.549 seconds (Warm-up)
#> Chain 4:                0.776 seconds (Sampling)
#> Chain 4:                2.325 seconds (Total)
#> Chain 4: 
