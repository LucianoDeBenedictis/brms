...
[`fcor`](https://paulbuerkner.com/brms/reference/fcor.md) for the new
...
- V:
  ...
  Known covariance matrix of the response variable. If a vector is
  passed, it will be used as diagonal entries (variances) and
  covariances will be set to zero.
