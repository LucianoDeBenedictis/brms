...
Set up a compounds symmetry (COSY) term in brms. The function does not
...
An object of class `'cosy_term'`, which is a list of arguments to be
...
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.002425 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 24.25 seconds.
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.575 seconds (Warm-up)
#> Chain 1:                2.714 seconds (Sampling)
#> Chain 1:                5.289 seconds (Total)
#> Chain 1: 
#> 
...
#> Chain 2:                2.444 seconds (Sampling)
#> Chain 2:                4.988 seconds (Total)
#> Chain 2: 
#> 
...
#> Chain 3: 
#> Chain 3:  Elapsed Time: 2.563 seconds (Warm-up)
#> Chain 3:                2.402 seconds (Sampling)
#> Chain 3:                4.965 seconds (Total)
#> Chain 3: 
#> 
...
#> Chain 4: 
#> Chain 4:  Elapsed Time: 2.744 seconds (Warm-up)
#> Chain 4:                2.378 seconds (Sampling)
#> Chain 4:                5.122 seconds (Total)
#> Chain 4: 
summary(fit)
#>  Family: gaussian 
#>   Links: mu = identity 
