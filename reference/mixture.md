...
#> Chain 2: 
#> Chain 2:  Elapsed Time: 1.438 seconds (Warm-up)
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 1.433 seconds (Warm-up)
...
#> Chain 1:                0.978 seconds (Sampling)
#> Chain 1:                2.066 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 1.071 seconds (Warm-up)
#> Chain 2:                0.91 seconds (Sampling)
#> Chain 2:                1.981 seconds (Total)
#> Chain 2: 
summary(fit3)
#>  Family: mixture(gaussian, gaussian) 
#>   Links: mu1 = identity; mu2 = identity 
...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.058 seconds (Warm-up)
#> Chain 1:                1.539 seconds (Sampling)
...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 170.479 seconds (Warm-up)
#> Chain 1:                201.039 seconds (Sampling)
#> Chain 1:                371.518 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
#> Chain 2: Gradient evaluation took 0.000209 seconds
#> Chain 2: 1000 transitions using 10 leapfrog steps per transition would take 2.09 seconds.
#> Chain 2: Adjust your expectations accordingly!
#> Chain 2: 
#> Chain 2: 
#> Chain 2: Iteration:    1 / 2000 [  0%]  (Warmup)
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 168.699 seconds (Warm-up)
#> Chain 2:                206.517 seconds (Sampling)
#> Chain 2:                375.216 seconds (Total)
#> Chain 2: 
