...
```
    ...
    ~phylo (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)    16.43      1.87    13.01    20.36 1.00     1860     3514

    ~species (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     4.99      0.83     3.28     6.59 1.00     1187     1975

    Regression Coefficients:
                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept       35.93      7.75    20.73    51.60 1.00     4704     4118
    spec_mean_cf     5.10      0.10     4.90     5.31 1.00     8865     4137

    Further Distributional Parameters:
          Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma     8.11      0.20     7.72     8.52 1.00     5696     3728
...
```
    ...
    ~phylo (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)    16.38      1.85    12.89    20.17 1.00     1429     2554

    ~species (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     5.04      0.81     3.45     6.58 1.00     1192     1824

    Regression Coefficients:
                   Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept         36.16      7.72    20.20    51.42 1.00     2772     3149
    spec_mean_cf       5.10      0.10     4.90     5.30 1.00     6596     4210
    within_spec_cf    -0.06      0.19    -0.43     0.32 1.00    11735     3692

    Further Distributional Parameters:
          Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma     8.11      0.21     7.72     8.52 1.00     6267     3813
...
```
    ...
    ~obs (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     0.05      0.03     0.00     0.10 1.01      972     2199

    ~phylo (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     0.06      0.04     0.00     0.15 1.01      711     1400

    Regression Coefficients:
              Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept     0.16      0.04     0.08     0.24 1.00     4246     2489
...
```
    ...
    ~obs (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     0.19      0.08     0.03     0.34 1.00      745      927

    ~phylo (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     0.18      0.10     0.02     0.40 1.00      573      763

    Regression Coefficients:
              Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept    -2.07      0.21    -2.49    -1.67 1.00     2723     2714
    cofactor      0.25      0.01     0.23     0.27 1.00     3935     2471
...
```
    ...
    ~phylo (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     0.71      0.52     0.03     1.93 1.00     1060     1309

    Regression Coefficients:
              Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept    -3.06      0.65    -4.40    -1.84 1.00     2130     1566
    cofactor      0.68      0.04     0.60     0.76 1.00     6480     2866

    Further Distributional Parameters:
          Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma     3.44      0.18     3.11     3.81 1.00     4171     2640
